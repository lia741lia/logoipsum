<div class="flex items-center flex-col gap-[12rem]">
    <div class="container m-auto done flex gap-8 mt-44 row-gap-64 " style="    margin-left: 145px;
    margin-top: 96px;">
        <img class="w-[608px] h-[517px] rounded-lg" src="/assets/img/Image Placeholder.png" />
        <div class="image-class leading-[310px] flex items-start flex-col">
            <div
                class="w-[552px] h-[93px] text-blue-950 text-[32px] font-bold font-['Rubik'] flex capitalize leading-[48px] flex-col">
                How to experience powerful <br> education free of charge<br /></div>
            <div class="data-reat flex mt-5 items-center ] " style="    display: flex;
    flex-direction: row;
    flex-wrap: nowrap;
    justify-content: flex-start;
    grid-gap: 11px;">
                <div class="text-zinc-500 text-sm gap-16 font-normal font-['Montserrat SemiBold'] leading-normal">3 May
                    2021
                </div>
                <div class="w-2 h-2 bg-blue-500 rounded-full"></div>
                <div class="text-zinc-500 text-sm font-normal font-['Montserrat SemiBold'] leading-normal">5 min read
                </div>
            </div>
            <p class=" text-zinc-500 font-normal mt-5 leading-[27px]">Lorem ipsum dolor sit amet, consectetur adipiscing
                elit.
                Nulla urna <br> dolor quis enim, convallis vitae maecenas. Orci, erat enim adipiscing <br> mattis elit
                nunc, sed
                facilisis. Enim, dui, diam sit at. Urna, sit sit eget <br> placerat eget hendrerit consequat. Risus,
                cursus nibh
                aliquet facilisis <br> laoreet sagittis quis. Aliquam amet, vel aliquam cursus aliquet <br> pellentesque
                aenean.
                Sit vestibulum malesuada eget pharetra. Risus <br> consequat bibendum dictum placerat convallis donec
                malesuada
                in <br> porttitor. Sag</p>
            <a href="/pages/rooter/read.php"
                class="text-sm mt-16  font-semibold leading-6 px-8 py-2 rounded-lg border border-[#421a55] bg-[#F72585] transition-all text-white">Read
                More</a>
        </div>
    </div>
    <div class="container m-auto done flex gap-8 mt-44 row-gap-64  " style="margin-left: 145px;
        margin-top: -64px;">
        <img class="w-[608px] h-[517px] rounded-lg" src="/assets/img/Image Placeholder (1).png" />
        <div class="image-class leading-[310px] flex items-start flex-col">
            <div
                class="w-[552px] h-[93px] text-blue-950 text-[32px] font-bold font-['Rubik'] flex capitalize leading-[48px] flex-col">
                How to experience powerful <br> education free of charge<br /></div>
    ...
    grid-gap: 11px;">
            ...
            <p class=" text-zinc-500 font-normal mt-5 leading-[27px]">Lorem ipsum dolor sit amet, consectetur adipiscing
                ...
                malesuada
                in <br> porttitor. Sag</p>
            <a href="/pages/rooter/Building.php"
                class="text-sm mt-16 font-semibold leading-6 px-8 py-2 rounded-lg border border-[#421a55] bg-[#F72585] transition-all text-white">Read
                More</a>
        </div>
    </div>
    <div class="container m-auto done flex gap-8 mt-44 row-gap-64 " style="margin-left: 145px;
        margin-top: -64px;">
        <img class="w-[608px] h-[517px] rounded-lg" src="/assets/img/Image Placeholder (2).png" />
        <div class="image-class leading-[310px] flex items-start flex-col  ">
            <div
                class="w-[552px] h-[93px] text-blue-950 text-[32px] font-bold font-['Rubik'] flex capitalize leading-[48px] flex-col">
                How to experience powerful <br> education free of charge<br /></div>
    ...
    <div class="container m-auto done flex gap-8 mt-44 row-gap-64 " style="margin-left: 145px;
        margin-top: -64px;">
        <img class="w-[608px] h-[517px] rounded-lg" src="/assets/img/Image Placeholder (3).png" />
        <div class="image-class leading-[310px] flex items-start flex-col ">
            <div
                class="w-[552px] h-[93px] text-blue-950 text-[32px] font-bold font-['Rubik'] flex capitalize leading-[48px] flex-col">
                How to experience powerful <br> education free of charge<br /></div>
...
<div class="justify-center text-center mt-11">
    <a href="#">&laquo;</a>
    <a href="#">1</a>
...
<div class="w-[1360px] m-auto mt-10 h-[435px] bg-slate-900 rounded-lg"></div>
<img class="w-[161px] h-8 relative bg-slate-200" src="./assets/img/logo.svg" alt="">
<svg class="h-8 w-auto" xmlns="http://www.w3.org/2000/svg" width="161" height="32" viewBox="0 0 161 32" fill="none">
    <path
        ...
        fill="white"></path>
    <path
        d="M29.4799 0H20.1377C24.8637 3.00768 28.8682 7.02862 31.8638 11.7743V2.39241C31.8634 1.75775 31.612 1.14924 31.165 0.700619C30.7179 0.252003 30.1118 -1.57043e-07 29.4799 0Z"
        fill="white"></path>
    <path
        ...
        fill="white"></path>
    <path d="M46.3138 3.52246H42.5723V22.4613H46.3138V3.52246Z" fill="white"></path>
    <path
        d="M60.0709 11.7278C59.448 11.1592 58.7189 10.7204 57.9259 10.4369C56.2224 9.83615 54.3659 9.83615 52.6624 10.4369C51.869 10.7202 51.1396 11.159 50.5165 11.7278C49.9055 12.2935 49.4173 12.9799 49.0826 13.7438C48.7367 14.5772 48.5586 15.4712 48.5586 16.3741C48.5586 17.277 48.7367 18.171 49.0826 19.0044C49.4161 19.7706 49.9044 20.4588 50.5165 21.0255C51.1385 21.5947 51.8675 22.0333 52.6607 22.3156C54.364 22.9174 56.2209 22.9174 57.9242 22.3156C58.7176 22.0333 59.4469 21.5947 60.0692 21.0255C60.6811 20.4585 61.1693 19.7704 61.5031 19.0044C61.849 18.171 62.0271 17.277 62.0271 16.3741C62.0271 15.4712 61.849 14.5772 61.5031 13.7438C61.1687 12.9801 60.6811 12.2938 60.0709 11.7278ZM57.5016 18.6044C56.8957 19.1525 56.1091 19.4558 55.2937 19.4558C54.4783 19.4558 53.6917 19.1525 53.0858 18.6044C52.5766 17.9731 52.2987 17.1853 52.2987 16.3728C52.2987 15.5604 52.5766 14.7726 53.0858 14.1413C53.6917 13.5932 54.4783 13.2899 55.2937 13.2899C56.1091 13.2899 56.8957 13.5932 57.5016 14.1413C58.0108 14.7726 58.2887 15.5604 58.2887 16.3728C58.2887 17.1853 58.0108 17.9731 57.5016 18.6044Z"
        fill="white"></path>
    <path
    ...
    <path
        ...
        fill="white"></path>
    <path d="M97.9226 10.3711H95.916V22.4612H97.9226V10.3711Z" fill="white"></path>
    <path
        ...
        fill="white"></path>
    <path
        d="M112.766 11.8738C112.201 11.295 111.522 10.8415 110.772 10.5424C109.949 10.2167 109.071 10.0545 108.187 10.0649C107.354 10.0553 106.53 10.2413 105.781 10.6081C105.044 10.9764 104.391 11.4953 103.864 12.1314H103.811V10.3715H101.807V28.352H103.811V20.3184H103.862C104.288 21.0552 104.909 21.6591 105.656 22.0632C106.523 22.5507 107.504 22.7961 108.497 22.7739C109.311 22.7791 110.116 22.6163 110.865 22.2956C111.587 21.9879 112.239 21.5351 112.781 20.9651C113.331 20.3825 113.763 19.6985 114.054 18.9508C114.672 17.3195 114.672 15.5176 114.054 13.8864C113.761 13.1369 113.323 12.453 112.766 11.8738ZM112.058 18.1895C111.871 18.7159 111.578 19.1982 111.198 19.6065C110.818 20.0149 110.359 20.3405 109.848 20.5634C108.72 21.0275 107.455 21.0275 106.326 20.5634C105.815 20.3405 105.355 20.0146 104.975 19.6058C104.594 19.197 104.301 18.7141 104.114 18.187C103.72 17.0412 103.72 15.7959 104.114 14.6502C104.301 14.1231 104.594 13.6401 104.975 13.2314C105.355 12.8226 105.815 12.4966 106.326 12.2738C107.455 11.8096 108.72 11.8096 109.848 12.2738C110.359 12.4966 110.819 12.8226 111.2 13.2314C111.58 13.6401 111.873 14.1231 112.06 14.6502C112.454 15.7959 112.454 17.0412 112.06 18.187L112.058 18.1895Z"
        fill="white"></path>
    <path
        ...
        fill="white"></path>
    <path
        d="M139.082 19.5938V10.3711H137.075V16.2658C137.081 16.9013 137.008 17.5351 136.856 18.1521C136.727 18.6811 136.5 19.1806 136.185 19.6241C135.886 20.0365 135.488 20.3654 135.027 20.5799C134.497 20.8162 133.922 20.9312 133.343 20.9167C132.951 20.9486 132.557 20.8854 132.194 20.7326C131.832 20.5797 131.511 20.3417 131.259 20.0384C130.777 19.3341 130.541 18.4892 130.588 17.6359V10.3711H128.581V17.8372C128.575 18.514 128.666 19.1881 128.851 19.8389C129.013 20.4158 129.299 20.9498 129.69 21.4026C130.081 21.8454 130.569 22.1912 131.115 22.4132C131.767 22.6684 132.462 22.7915 133.161 22.7753C133.631 22.7791 134.099 22.7135 134.55 22.5807C134.957 22.4616 135.346 22.288 135.707 22.0645C136.035 21.8615 136.334 21.6138 136.594 21.3285C136.829 21.0747 137.024 20.7872 137.174 20.4755H137.225C137.225 20.8207 137.234 21.1576 137.251 21.486C137.268 21.8144 137.277 22.1417 137.276 22.4679H139.18C139.18 22.071 139.163 21.6317 139.129 21.15C139.094 20.6683 139.078 20.1496 139.082 19.5938Z"
        fill="white"></path>
    <path
