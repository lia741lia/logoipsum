<header class="bg-white">
  <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
    <div class="flex lg:flex-1">
      ...
      <div class="mr-6 ml-6 flex items-center justify-between w-full p-3 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
        <input type="text" name="first-name" id="first-name" autocomplete="given-name" class="bg-transparent outline-none w-full" placeholder="Search bar">
    ...
    <div class="hidden lg:flex lg:flex-1 lg:justify-end items-center gap-4">
      <a href="#" class="text-sm font-semibold leading-6 text-gray-900 py-2 px-8 border border-[#1C3554] rounded-lg">Sign In</a>
      <a href="#" class="text-sm font-semibold leading-6 text-gray-900 py-2 px-8 border border-[#F72585] bg-[#F72585] rounded-lg text-white">Sign
        Up</a>
    </div>
  </nav>
          ...
          <div class="space-y-2 py-6">
            <div class="-mx-3">
              ...
              <div class="mt-2 space-y-2" id="disclosure-1">
                ...
                <a href="#" class="block rounded-lg py-2 pl-6 pr-3 text-sm font-semibold leading-7 text-gray-900 hover:bg-gray-50">Watch
                  demo</a>
                <a href="#" class="block rounded-lg py-2 pl-6 pr-3 text-sm font-semibold leading-7 text-gray-900 hover:bg-gray-50">Contact
                  sales</a>
              </div>
            </div>
